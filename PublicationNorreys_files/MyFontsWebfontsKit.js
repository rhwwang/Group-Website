...
function din_loaded()
{
  document.documentElement.className += " din-loaded";
}
//-DJM
...
suffix="_unhinted";var fonts=[{"fontFamily":"DINCondensedA","url":wfpath+"288805_0"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"288805_data_unhintedttf.css":"288805_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"288805_data_unhintedwoff.css":"288805_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
